...
public class ShowHBoxVBox extends Application {
    ...
    private HBox getHBox() {
        ...
        hBox.getChildren().add(new Button("But 1"));
        hBox.getChildren().add(new Button("But 2"));
        hBox.getChildren().add(new Button("But 3"));

        //ImageView imageView = new ImageView(new Image("unknown.png"));
