...
class LinePane extends Pane {
    public LinePane() {
        ...
        Line myLine = new Line(10, 10, 125, 170);
        myLine.setStrokeWidth(25);
        myLine.setStroke(Color.DEEPPINK);
        ...
        line2.startXProperty().bind(widthProperty().subtract(25));
        line2.endYProperty().bind(heightProperty().subtract(25));
